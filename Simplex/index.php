...
<html>
    ...
    <body>        
        <div class="container">
            <div id="seleccionar" class="jumbotron">
               <center> <h1>Investigación de Operaciones</h1></center>
               <center> <a onclick="display_simplex()" class="btn btn-lg btn-success" role="button">Método simplex</a></center>
            </div>
        <div class="row" id="simplex" style="display: none">
            <div class="col-lg-6">
            <center><h3>Ingrese número de variables</h3><input style="height: 30px; width: 50px;" type="number" id="num_variables" /></center>
            </div>
            <div class="col-lg-6">
            <center><h3>Ingrese número de restricciones</h3><input style="height: 30px; width: 50px;" type="number" id="num_restricciones" /><br></center>
            </div>
            <div class="row" style="text-align: center">
            <button class="btn btn-primary" onclick="crearCampos()" />IR</button><hr>
            </div>
